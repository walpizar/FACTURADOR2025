    ...
    {  
        ...
        private void agregarProductoDetalleFactura(tbProducto pro, int tipo, decimal cantidad, decimal desc, bool acumular, bool isActualizacion)
        {
            try
            {
               ...
               // cantidad = Math.Round(cantidad, 5);
        ...
        private decimal buscarPrecioProducto(tbProducto pro)
        {
            ...
            if (clienteGlo != null)
            {
                preciobase = clienteGlo.precioAplicar;
                    ...
                    if (dtgvDetalleFactura.Rows[e.RowIndex].Cells[1].Value != null)
                    {
                        ...
                        if (dtgvDetalleFactura.Rows[e.RowIndex].Cells[8].Value != null)
                        {
                            ...
                            if (prod != null)
                            {
                                ...
                                decimal cantiNueva = precioProd / prod.precioVenta1;
                ...
                if (doc.reporteElectronic)
                {
                    try
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            MessageBox.Show("Error Enviar factura hacienda.", "Error Hacienda", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        ...
                        {
                            clsEvento evento = new clsEvento(ex.Message, "1");
                            MessageBox.Show("Error consultar factura hacienda.", "Error Hacienda", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void enviarCorreos(List<tbDocumento> lista)
        {
        ...
        private void precio1_Click(object sender, EventArgs e)
        {
        ...
        private void txtPorcetaje_KeyDown(object sender, KeyEventArgs e)
        {
