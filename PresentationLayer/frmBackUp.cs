...
namespace PresentationLayer
{
    public partial class frmBackUp : Form
    {
        ...
        private void realizarRespaldo()
        {
            ...
            //try
            //{
            //    var connectionString = CommonLayer.Global.conexionReportes;
            //    var sqlConStrBuilder = new SqlConnectionStringBuilder(connectionString);

            //    Server dbServer = new Server(new Microsoft.SqlServer.Management.Common.ServerConnection(sqlConStrBuilder.DataSource, sqlConStrBuilder.UserID, sqlConStrBuilder.Password));

            //    Backup dbBackUp = new Backup() { Action = BackupActionType.Database, Database = "dbSISSODINA" };

            //    var backupFolder = CommonLayer.Global.Usuario.tbEmpresa.tbParametrosEmpresa.FirstOrDefault().rutaBackUp.Trim();
            ...
            //    dbBackUp.PercentComplete += dbBackUp_PocentajeCompletado;
            //    dbBackUp.Complete += dbBacupCompletado;
            ...
            //    MessageBox.Show("Error al realizar el respaldo", "Respaldo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //}
            try
            {
