...
PRINT '-------- VERICA CABYS QUE SE TIENE ELIMINAR DE NUESTRA BD --------';  
...
BEGIN  
	...
	IF(not EXISTS(SELECT * FROM TempCompleto WHERE idCategoria9=@id9))BEGIN
		INSERT INTO cabysEliminar values(@id9)
	END
